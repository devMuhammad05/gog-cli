...
{
    protected $signature = 'gmail:list {--limit=10 : The number of emails to retrieve}';
    protected $description = 'List recent emails from Gmail';
    ...
    public function handle(GmailService $gmailService)
    {
        ...
        try {
            $emails = spin(fn() => $this->fetchEmails($gmailService, $limit), 'Fetching emails...');
    ...
    private function fetchEmails(GmailService $gmailService, int $limit): array
    {
        $messages = $gmailService->listMessages($limit);
